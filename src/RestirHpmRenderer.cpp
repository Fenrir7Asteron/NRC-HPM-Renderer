...
namespace en
{
	...
	RestirHpmRenderer::RestirHpmRenderer(
		...
		m_RenderShader("restir/render.comp", true),
		m_TemporalReuseShader("restir/temporal_reuse.comp", true),
		m_SpatialReuseShader("restir/spatial_reuse.comp", true),
		m_LocalInitShader("restir/local_init.comp", true),
		m_UniformBuffer(
			sizeof(UniformData), 
