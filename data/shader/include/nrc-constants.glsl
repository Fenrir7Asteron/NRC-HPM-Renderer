...
layout(constant_id = 4) const float TRAIN_X_DIST = 0.0;
layout(constant_id = 5) const float TRAIN_Y_DIST = 0.0;
...
layout(constant_id = 11) const uint INFER_BATCH_SIZE_VERTICAL = 1;
layout(constant_id = 12) const uint INFER_BATCH_SIZE_HORIZONTAL = 1;
layout(constant_id = 13) const uint TRAIN_BATCH_SIZE_VERTICAL = 1;
layout(constant_id = 14) const uint TRAIN_BATCH_SIZE_HORIZONTAL = 1;

layout(constant_id = 15) const float VOLUME_SIZE_X = 1.0;
layout(constant_id = 16) const float VOLUME_SIZE_Y = 1.0;
layout(constant_id = 17) const float VOLUME_SIZE_Z = 1.0;
layout(constant_id = 18) const float VOLUME_DENSITY_FACTOR = 1.0;
layout(constant_id = 19) const float VOLUME_G = 0.7;

layout(constant_id = 20) const float HDR_ENV_MAP_STRENGTH = 1.0;
